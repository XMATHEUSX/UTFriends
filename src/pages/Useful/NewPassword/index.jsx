  ...
  function Success() {
    return (
      <UsefulBox
        ...
        button={"Fazer Login"}
        message={
          "Sua senha foi alterada com sucesso, realize o login para acessar sua conta"
        }
        width={"25%"}
        height={"20%"}
    ...
    <div className="conteinerNP">
      ...
      <div className="boxNP">
        ...
        <div className="contentBoxNP">
          ...
          <p className="errorMsgNP" id="noSenha">
            {" "}
            Campo obrigatório{" "}
          </p>

          <p className="errorMsgNP" id="erroSenha">
            {" "}
            Senha fraca{" "}
          </p>
        </div>
        ...
        <div className="contentBoxNP">
          ...
          <p className="errorMsgNP" id="erroSenhaRep">
            {" "}
            Senha divergente{" "}
          </p>
        </div>
